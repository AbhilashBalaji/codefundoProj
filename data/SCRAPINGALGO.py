...
for index,rows in maindf.iterrows():
	maindf.loc[index,'datetime'] = datetime.datetime(maindf.loc[index,'year'],maindf.loc[index,'month'],maindf.loc[index,'day'],maindf.loc[index,'hour'],maindf.loc[index,'mins'],0)
