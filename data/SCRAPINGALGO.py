...
irenebuoy = ["42060", "41043", "41046", "fwyf1", "spgf1", "41004",
             "41013", "41025", "44014", "44009", "44025", "44020"]  # bouynumber array
year = "2011"  # year


testdf = pd.read_csv("stations.csv", encoding="UTF-8")
stationdic = {}
...
maindf['waveperiod'] = pd.to_numeric(
    maindf['waveperiod'], errors='coerse', downcast='float')
maindf['wavedirection'] = pd.to_numeric(
    maindf['wavedirection'], errors='coerse', downcast='float')
